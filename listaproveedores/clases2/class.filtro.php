...
define("__ROOT1__", dirname(dirname(__FILE__)));
	...
	public function productosservicios($id){
		$conn = $this->db();
		$productosservicios = 'select * from 02productosservicios where idRelacion = "'.$id.'" ';
		$query_productosservicios=mysqli_query($conn,$productosservicios);
			$row_productosservicios = mysqli_fetch_array($query_productosservicios,MYSQLI_ASSOC);
				 //$P_NOMBRE_COMERCIAL_EMPRESA = $row_direccionproveedor['P_NOMBRE_COMERCIAL_EMPRESA'];
			
		return $row_productosservicios;
	}
...
public function convenionuevo($id) {
	...
	public function direccionproveedor1($id){
		...
		$query_direccionproveedor1=mysqli_query($conn,$direccionproveedor1);
			$row_direccionproveedor1 = mysqli_fetch_array($query_direccionproveedor1,MYSQLI_ASSOC);			
		return $row_direccionproveedor1;
	}
