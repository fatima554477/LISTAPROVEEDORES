...
<strong><p class="mb-0 text-uppercase" style="font-size:22px;">&nbsp;&nbsp;&nbsp;ALTA DE PROVEEDORES</p> </strong> </div> 	 			 
			 
<div id="content" >     

			  <strong><p class="mb-0 text-uppercase">&nbsp;&nbsp;&nbsp;MOSTRAR TODO
<img src="includes/contraertodos11.png" id="mostrartodos" onclick="load(1); load2(1);" style="cursor:pointer;"/>&nbsp;&nbsp;&nbsp;CONTRAER TODO
<img src="includes/contraertodos2.png" id="ocultartodos" style="cursor:pointer;"/><span style="font-size:20px;color:#8c10a8">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<?php echo  isset($NFE_INFORMACION)?'||'.$NFE_INFORMACION:'';?>&nbsp;<?php echo  isset($NCE_INFORMACION)?$NCE_INFORMACION:'';?>	 </p> </strong> </div>
