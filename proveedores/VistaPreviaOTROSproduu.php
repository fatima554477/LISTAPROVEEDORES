 ...
 $output .= ' <form  id="listadootrosdocuumentosform"> 
    ...
    while($row = mysqli_fetch_array($queryVISTAPREV))
    {
        ...
        if($row["F_PADJUNTAR_OTRO_DOCUMENTO_5_1"]!=""){
            $urlF_PADJUNTAR_OTRO_DOCUMENTO_5_1= "<a target='_blank'
            href='includes/archivos/".$row["F_PADJUNTAR_OTRO_DOCUMENTO_5_1"]."'>Visualizar!</a>";
            }else{
            $urlF_PADJUNTAR_OTRO_DOCUMENTO_5_1="";
            }
...
<td width="70%"><div class="col-md-6"> <div id="drop_file_zone" ondrop="upload_file(event, \'F_PADJUNTAR_OTRO_DOCUMENTO_5_1\');" ondragover="return false" style="width:300px;"> <p>Suelta aquí o busca tu archivo</p> <p> <input class="form-control form-control-sm" id="F_PADJUNTAR_OTRO_DOCUMENTO_5_1" type="text" onkeydown="return false" onclick="file_explorer(\'F_PADJUNTAR_OTRO_DOCUMENTO_5_1\');" style="width:250px;" value="'.$row["F_PADJUNTAR_OTRO_DOCUMENTO_5_1"].'" required /> </p> <input type="file" name="F_PADJUNTAR_OTRO_DOCUMENTO_5_1" id="nono"/> <div id="2F_PADJUNTAR_OTRO_DOCUMENTO_5_1"> '.$urlF_PADJUNTAR_OTRO_DOCUMENTO_5_1.'</div> </div> </div></td>
</tr> <tr>
