...
$QUIENINGRESO = isset($_POST["QUIENINGRESO"])?$_POST["QUIENINGRESO"]:"";                                 
...
echo $proveedoresC->CALIFICACION( $DOCUMENTO_CALIFICACION ,$ADJUNTO_CALIFICACION, $OBSERVACIONES_CALIFICACION ,$QUIENINGRESO, $FECHA_CALIFICACION , $hCALIFICACION,$IpCALIFICACION,$enviarCALIFICACION );
...
$FOTO_ESTADO_PROVEE = isset($_POST["FOTO_ESTADO_PROVEE"])?$_POST["FOTO_ESTADO_PROVEE"]:"";

if(isset($_FILES["FOTO_ESTADO_PROVEE"]) && $_FILES["FOTO_ESTADO_PROVEE"]["error"] == UPLOAD_ERR_OK){

	$FOTO_ESTADO_PROVEE_CARGADA = $conexion->solocargar("FOTO_ESTADO_PROVEE");

	if($FOTO_ESTADO_PROVEE_CARGADA!='2' && $FOTO_ESTADO_PROVEE_CARGADA!='' && $FOTO_ESTADO_PROVEE_CARGADA!='1'){

		$FOTO_ESTADO_PROVEE = $FOTO_ESTADO_PROVEE_CARGADA;
