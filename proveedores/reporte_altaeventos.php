...
$_SESSION['id'] = $_SESSION['idem'];
		...
		require "listadeEVENTOS/controladorAE.php";
        //require "listadeEVENTOS/variables.php";
?><!doctype html>
<html lang="en" class="light-theme">
  <head>
    ...
    <script type="text/javascript" src="listadeEVENTOS/typeahead.js"></script>
	<style>
...
color:red;
 ...
 <!--start wrapper-->
    <div class="wrapper">
     ...
     <!--end sidebar -->
        ...
        <!--start top header-->
		  ...
		  require "includes/notificaciones.php"; /*php notificaciones*/ ?>
          </header>
        <!--end top header-->
	...
	require "listadeEVENTOS/mapeo1.php"; /*php mapa*/ ?>
          </div>
          <!--end breadcrumb-->
...
<?php
   ...
   require "listadeEVENTOS/expansores.php";
  // require "listadeEVENTOS/EVENTOS1.php";
   
      require "listadeEVENTOS/fetch_page_eventos.php";
  ...
  <!--end wrapper-->
	...
	<?php require "listadeEVENTOS/scriptAE.php"; ?>
