...
<strong><p class="mb-0 text-uppercase" style="font-size:18px;">&nbsp;FORMULARIO PROVEEDORES</p> </strong> </div> 		 
			 
  

			<div>  <strong><p class="mb-0 text-uppercase">&nbsp;&nbsp;&nbsp;MOSTRAR TODO
<img src="includes/contraertodos11.png" id="mostrartodos" style="cursor:pointer;"/>&nbsp;&nbsp;&nbsp;CONTRAER TODO
<img src="includes/contraertodos2.png" id="ocultartodos" style="cursor:pointer;"/><span style="font-size:20px;color:#8c10a8">&nbsp;<?php echo  isset($P_NOMBRE_COMERCIAL_EMPRESA)?'  '.$P_NOMBRE_COMERCIAL_EMPRESA:'';?>&nbsp;&nbsp;
<?php echo  isset($P_NOMBRE_FISCAL_RS_EMPRESA)?'NOMBRE FISCAL:&nbsp;    '.$P_NOMBRE_FISCAL_RS_EMPRESA:'';?>	 </p> </strong> </div>
